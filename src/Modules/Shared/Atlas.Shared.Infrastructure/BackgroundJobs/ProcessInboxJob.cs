...
/// <summary>
/// Implements a background job responsible for processing messages from the inbox.
/// </summary>
    ...
    where TCompositionRoot : ICompositionRoot
{
    ...
    /// <summary>
    /// Asynchronously executes the job, which in this case sends a <see cref="ProcessInboxCommand"/> 
