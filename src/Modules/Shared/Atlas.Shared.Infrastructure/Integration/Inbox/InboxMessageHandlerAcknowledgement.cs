...
/// </summary>
/// <remarks>
/// There is a unique constraint upon the InboxMessageId and HandlerName properties, meaning that a consumer (inbox message handler) has a record of processing any inbox messages, and therefore
