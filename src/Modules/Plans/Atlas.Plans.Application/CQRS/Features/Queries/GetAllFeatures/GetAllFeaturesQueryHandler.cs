...
public sealed class GetAllFeaturesQueryHandler(IFeatureRepository featureRepository, IMapper mapper) : IQueryHandler<GetAllFeaturesQuery, IEnumerable<FeatureDto>>
{
