...
internal sealed class GetHasPaymentMethodBeenUsedBeforeQueryHandler(IStripeService stripeService, IStripeCardFingerprintRepository stripeCardFingerprintRepository) : IRequestHandler<GetHasPaymentMethodBeenUsedBeforeQuery, bool>
{
