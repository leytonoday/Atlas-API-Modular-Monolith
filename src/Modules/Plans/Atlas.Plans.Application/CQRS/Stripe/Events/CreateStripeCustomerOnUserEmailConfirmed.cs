...
public sealed class CreateStripeCustomerOnUserEmailConfirmed(IStripeService stripeService, IStripeCustomerRepository stripeCustomerRepository, UserManager<User> userManager) : INotificationHandler<UserEmailConfirmedIntegrationEvent>
{
