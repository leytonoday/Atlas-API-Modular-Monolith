...
namespace Atlas.Users.Infrastructure.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "UsersOutboxMessageConsumerAcknowledgements",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersOutboxMessageConsumerAcknowledgements", x => new { x.DomainEventId, x.EventHandlerName });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersOutboxMessages", x => x.Id);
                });
